...
public class NotificationServiceImpl implements INotificationService {
    ...
    @Override
    public Mono<GetAllNotifiedEmailsResponse> getAllNotifiedEmails(GetAllNotifiedEmailsRequest getAllNotifiedEmailsRequest) {
        return Mono.justOrEmpty(getAllNotifiedEmailsRequest)
    ...
    public Mono<List<String>> getNotifiedEmailListFromOneEmail(String inputEmail, String text) {
    ...
    public Flux<String> findMentionedEmails(String text) {
